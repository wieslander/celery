...
from celery.django.backends.cache import CacheBackend
...
class test_custom_CacheBackend(unittest.TestCase):
    ...
    def test_custom_cache_backend(self):
        ...
        prev_module = sys.modules['celery.django.backends.cache']
        current_app.conf.CELERY_CACHE_BACKEND = 'dummy://'
        sys.modules.pop('celery.django.backends.cache')
        try:
            from celery.django.backends.cache import cache
            ...
            sys.modules['celery.django.backends.cache'] = prev_module
...
class test_MemcacheWrapper(unittest.TestCase):
    ...
    def test_memcache_wrapper(self):
        ...
        prev_backend_module = sys.modules.pop('celery.django.backends.cache')
        try:
            from celery.django.backends.cache import cache
            ...
            sys.modules['celery.django.backends.cache'] = prev_backend_module
